...
module.exports = {
  confirm: (id) => ({
    ...
    <br />
      <a href='${CLIENT_ORIGIN}/en/confirm/${id}' style="text-decoration: none; color: #2855ac; background-color: #fff; padding: 20px; border-radius: 20px;  ">
      Click to confirm email!
        ...
        alt="turkcell" /></div>
    `,
    text: `Copy and paste this link: ${CLIENT_ORIGIN}/en/confirm/${id}`,
  }),
};
