...
class StudentList extends React.Component {
  ...
  render() {
    ...
    ['gender', 'plaza', 'kind', 'not'].forEach(function (filterBy) {
    ...
    let genderArray = this.props.data.map(function (item) {
      return item.gender;
    });
    genderArray = genderArray.filter((val, i, self) => self.indexOf(val) === i);
          ...
          <Col sm={3}>
            ...
            <div className='form-label-group'>
              <select
                ...
                placeholder=' '
                onChange={handleChangeOption.bind(this, 'gender')}
              >
                      ...
                      >
                        ...
                        <Card.Body>
                          ...
                          >
                            ...
                            <div style={{ textAlign: 'center' }}>
                              <Link
                                to={`/en/${props.id}/project`}
                                style={{ margin: '0px 10px' }}
                              >
                                <button className='foto'>Project</button>
                              </Link>
                              <Link
                                to={`/en/${props.id}/presentation`}
                                style={{ margin: '0px 10px' }}
                              >
                                <button className='foto'>Presentation</button>
                              </Link>
                            </div>
                          </div>
                        </Card.Body>
                  ...
                  >
                    ...
                    <Card.Body>
                      ...
                      >
                        ...
                        <div style={{ textAlign: 'center' }}>
                          <Link to={`/${item.id}/turkcellproject`}>
