              ...
              <div key='tab-content'>
                ...
                {value === 1 && (
                  <div>
                    ...
                    >
                      <h3>Sizin için zorunlu staj uygunsa hemen katıl!</h3>
                      <Link to='/Basvura/Zorunlu'>
                        <button className='foto'>STAJA KATIL!</button>
                      </Link>
                    </div>
                ...
                {value === 2 && (
                  <div>
                    ...
                    >
                      <h3>Sizin için gönüllü staj uygunsa hemen katıl!</h3>
